...
<script type="text/javascript">
	function chageCheckCodeImage() {
		document.getElementById("checkCodeImage").src="${pageContext.request.contextPath}/createcheckcode.action?type=1&"+new Date().getTime();;
	}
</script>
		...
		<div class="span12 last">
			<div class="wrap">
				<div class="main">
					...
					<form id="loginForm"  method="post" action="user_login.action" novalidate="novalidate">
						<table>
							<tbody><tr>
								<th>
										用户名/E-mail:
							...
							<tr>
								...
								<tr>
									...
									<td>
										<span class="fieldSet">
											<input type="text" id="checkCode" name="checkCode" class="text captcha" maxlength="4" autocomplete="off"><img id="checkCodeImage" class="captchaImage" src="${pageContext.request.contextPath}/createcheckcode.action?type=1" 
											title="点击更换验证码" onclick="chageCheckCodeImage()">
										</span>
									</td>
								</tr>
							<tr>
