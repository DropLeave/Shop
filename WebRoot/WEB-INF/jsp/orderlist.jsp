			...
			<ul>
				...
				<table>
					...
					<tr>
						...
						<th colspan="2"> 金额:<s:property  value="#order.total"/></th>
						<th colspan="2"> 
						状态:
						...
						<s:elseif test="#order.state==3"><a href="${pageContext.request.contextPath}/order_updateState.action?oid=<s:property  value="#order.oid"/>"><font color="red">确认收货</font></a></s:elseif>
