...
<!-- 					<div class="newProductAd">
						 ...
						 <ul class="tabContent" style="display: block;">
						 	<s:iterator value="newList">
								...
								<li>
									<a  target="_blank" href="${pageContext.request.contextPath}/product_findByPid.action?pid=<s:property  value="pid"/>"><img src="${pageContext.request.contextPath}/<s:property value="image"/>" />
								</li>
							</s:iterator>		
						</ul>
						<ul class="tabContent" style="display: none;">
