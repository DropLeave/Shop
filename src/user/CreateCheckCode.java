 ...
 * 
 */
public class CreateCheckCode extends ActionSupport {
private Integer type;
	...
	public String execute() throws Exception {
		...
		//2表示注册验证码
		if(type==1){
			ServletActionContext.getRequest().getSession().setAttribute("checkcode_login", sb.toString());
		}else if(type==2){
		ServletActionContext.getRequest().getSession()
				.setAttribute("checkcode_regist", sb.toString());
